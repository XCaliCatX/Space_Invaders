...
class Laser(Sprite):
    ...
    alien_laser_images = [pg.image.load(f'images/alien_laser_{n}.png') for n in range(2)]
    ship_laser_images = [pg.image.load(f'images/ship_laser_{n}.png') for n in range(2)]
